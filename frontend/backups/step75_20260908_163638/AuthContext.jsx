...
import { signInWithEmailAndPassword, signInWithPopup, signInWithRedirect, getRedirectResult, linkWithPopup } from 'firebase/auth';
...
export const AuthProvider = ({ children }) => {
  ...
  return (
    <AuthContext.Provider value={{
      user, token, login, loginWithEmail, loginWithGoogle, linkGoogleAccount, logout, loading, initialized, updateUser
    }}>
      {children}
