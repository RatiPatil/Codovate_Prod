  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div ref={bgRef} className="absolute inset-0 pointer-events-none"
        style={{
          background: 'radial-gradient(ellipse at 50% 50%, rgba(32,21,255,0.12) 0%, transparent 60%)',
        }}
      />
      ...
      <div ref={cardRef} className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 text-sm mt-2">Sign in to continue your growth journey</p>
        </div>
        ...
        <div className="bg-[#0a0a0a] border border-white/10 rounded-2xl p-8 shadow-2xl"
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full relative bg-primary hover:bg-primary-dark text-white font-semibold py-3.5 rounded-xl transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-primary/20 hover:shadow-primary/40 hover:scale-[1.02] active:scale-[0.98]"
            >
              {loading ? (
          ...
          <div className="flex items-center gap-3 my-6">
            ...
            <span className="text-gray-600 text-xs">New to Codovate?</span>
            <div className="flex-1 h-px bg-white/10" />
          </div>
