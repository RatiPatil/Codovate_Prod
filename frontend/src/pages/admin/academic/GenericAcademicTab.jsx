...
/**
 * A highly reusable Tab component that provides a full DataTable + Form Modal
 * lifecycle for any Academic Structure entity.
 */
export const GenericAcademicTab = ({ 
  title, 
  apiClient, 
  columns, 
  formSchema, 
  ...
  const handleDelete = async (id) => {
    if (!window.confirm('Are you sure you want to DELETE this record? (Soft Delete)')) return;
    try {
