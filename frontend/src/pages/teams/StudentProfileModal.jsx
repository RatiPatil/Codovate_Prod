      ...
      <div className="relative z-10 w-[95vw] md:w-full max-w-5xl bg-white border border-slate-200 rounded-2xl shadow-2xl my-10 overflow-hidden flex flex-col">
        ...
        <div className="px-6 md:px-10 pb-10">
          ...
          <div className="flex flex-col md:flex-row md:items-end gap-6 -mt-16 mb-8 relative z-10">
            <div className="w-32 h-32 rounded-full bg-white border-4 border-white flex items-center justify-center overflow-hidden shrink-0 shadow-xl">
              {student.profile_photo || student.avatar ? (
                ...
                <span className="text-4xl font-bold text-indigo-600">{student.name?.charAt(0).toUpperCase()}</span>
              )}
            </div>
            
            <div className="flex-1 pb-2">
              <div className="flex flex-wrap items-center gap-3 mb-1">
                <h2 className="text-3xl font-bold text-slate-900">{student.name || 'Anonymous User'}</h2>
